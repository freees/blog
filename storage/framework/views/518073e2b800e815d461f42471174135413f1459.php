          ...
          <form method="post">
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="text" id="email" name="email" required lay-verify="email" autocomplete="off" value="<?php echo e($user->email); ?>" class="layui-input">
              </div>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="text" id="mobile" name="mobile" required lay-verify="phone" autocomplete="off" value="<?php echo e($user->mobile); ?>" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item">
              <label for="L_username" class="layui-form-label">昵称</label>
              <div class="layui-input-inline">
                <input type="text" id="nick_name" name="nick_name" required lay-verify="required" autocomplete="off" value="<?php echo e($user->nick_name); ?>" class="layui-input">
              </div>
              <div class="layui-inline">
                <div class="layui-input-inline">
                  <input type="radio" name="sex" value="男" <?php if($user->sex =='男'): ?> checked <?php endif; ?> title="男">
                  <input type="radio" name="sex" value="女" <?php if($user->sex =='女'): ?> checked <?php endif; ?> title="女">
                </div>
              </div>
            </div>
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                <input type="text" id="area" name="area" autocomplete="off" value="<?php echo e($user->area); ?>" class="layui-input">
              </div>
            </div>
            <div class="layui-form-item layui-form-text">
              <label for="L_sign" class="layui-form-label">签名</label>
              <div class="layui-input-block">
                <textarea placeholder="随便写些什么刷下存在感" id="signature"  name="signature" autocomplete="off" class="layui-textarea" style="height: 80px;"><?php echo e($user->signature); ?></textarea>
              </div>
            </div>
            <div class="layui-form-item">
          ...
          <div class="layui-form layui-form-pane layui-tab-item" id="avatar">
            <div class="layui-form-item">
              <div class="avatar-add">
                ...
                <img src="<?php echo e($user->face_img); ?>" id="face_img_url">
...
<script>
  layui.use(['layedit','upload'], function(){
    ...
    form.on('submit(set1)', function(data){
      $.post("<?php echo e(url('set')); ?>",data.field,function(res){
        if(res.code == '1'){
