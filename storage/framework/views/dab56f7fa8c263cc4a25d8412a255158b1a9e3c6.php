    ...
    <div class="layui-col-md8">
      <div class="fly-panel" style="margin-bottom: 0;">
        ...
        <div class="fly-panel-title fly-filter">
          <a href="<?php echo e(route('article_list',['create_time'=>'desc'])); ?>"  <?php if($order == 'create_time'): ?> class="layui-this" <?php endif; ?>>最新</a>
          <span class="fly-mid"></span>
          <a href="<?php echo e(route('article_list',['page_views'=>'desc'])); ?>" <?php if($order == 'page_views'): ?> class="layui-this" <?php endif; ?>>热度</a>
          <span class="fly-mid"></span>
          <a href="<?php echo e(route('article_list',['comment_num'=>'desc'])); ?>" <?php if($order == 'comment_num'): ?> class="layui-this" <?php endif; ?>>评论</a>
          <span class="fly-mid"></span>
          <a href="<?php echo e(route('article_list',['is_fine'=>'desc'])); ?>" <?php if($order == 'is_fine'): ?> class="layui-this" <?php endif; ?>>精贴</a>
        </div>
        ...
        <ul class="fly-list">
          ...
          <li>
            ...
            <div class="fly-list-info">
              ...
              <span class=" layui-hide-xs" title=""><i class="iconfont" title="人气">&#xe60b;</i> <?php echo e($v->page_views); ?></span>
