...
<div class="layui-container fly-marginTop fly-user-main">
  ...
  <div class="fly-panel fly-panel-user" pad20>
    <ul class="layui-tab-title" style="width: 93%;margin: auto">
      <li class="layui-this"><?php if($to_user_no != 'all'): ?><?php echo e($to_nick_name); ?> <?php else: ?> 群聊（<span id="onlie_count"></span>）<?php endif; ?></li>
    </ul>
...
<script>
  layui.use(['layedit'], function(){
    ...
    layedit.set({
      uploadImage: {
        url: '<?php echo e(url('upload_chat_image')); ?>' //接口url
        ,type: 'post' //默认post
      }
    });
...
<script>
  ...
  var to_user_no = '<?php echo e($to_user_no); ?>';
  var user_no = '<?php echo e($user->user_no); ?>';
  var nick_name = '<?php echo e($user->nick_name); ?>';
  var face_img = '<?php echo e($user->face_img); ?>';
