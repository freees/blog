                ...
                <tr style="margin: 0; padding: 0;">
                    <td style="margin: 0; padding: 30px;">
                        <p style="line-height: 20px; margin: 0; margin-bottom: 10px; padding: 0;">
                            Hi，<em style="font-weight: 700;"><?php echo e($nick_name); ?></em>，请完成以下操作： </p>
                        <div style="">
                            <a href="http://www.laravel.cn:81/check_email?user_no=<?php echo e($user_no); ?>" style="background-color: #009E94; color: #fff; display: inline-block; height: 32px; line-height: 32px; margin: 0 15px 0 0; padding: 0 15px; text-decoration: none;" target="_blank" rel="noopener">立即激活邮箱</a>
                        </div>
